...
import static demo.example.blogspring.model.Gender.MALE;
...
public class BlogSpringApplication {
    ...
    public CommandLineRunner runner(AuthorRepository authorRepository, PostRepository postRepository){
        return args -> {
            ...
            Post p1=new Post("www","essdds",LocalDate.now());
            Post p2=new Post("www","essdds",LocalDate.now());
            Post p3=new Post("www","essdds",LocalDate.now());
